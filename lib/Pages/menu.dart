...
class ListProduits extends StatelessWidget {
  ...
  final List<Salade> produits = [
    ...
    Repas(
      nom: "Alloco Poisson",
      description: "Poisson grillé accompagné d’alloco (bananes plantains frites), servi avec une petite sauce maison.",
      prix: 18.00,
      image: "assets/images/Repas/allocopoisson.jpeg",
    ),
    Repas(
      nom: "Attiéké Poisson",
      description: "Attiéké ivoirien accompagné d’un poisson braisé, tomate, oignon, piment et sauce verte traditionnelle.",
      prix: 17.00,
      image: "assets/images/Repas/attiekepoisssson.jpg",
    ),
    Repas(
      nom: "Tajine Marocain aux Pruneaux",
      description: "Tajine marocain traditionnel à la viande, pruneaux, amandes et épices orientales.",
      prix: 20.00,
      image: "assets/images/Repas/tajine-marocain-aux-pruneaux.jpg",
    ),
    Repas(
      nom: "Tajine Marocain Traditionnel",
      description: "Tajine aux légumes variés, épices marocaines et viande tendre cuite lentement.",
      prix: 18.00,
      image: "assets/images/Repas/salades12.jpg",
    ),
    Repas(
      nom: "Brochettes Grillées",
      description: "Brochettes de viande marinée, grillées au feu et servies avec une sauce épicée.",
      prix: 15.00,
      image: "assets/images/Repas/Brochette.jpeg",
    ),
    Repas(
      nom: "Riz Sauce Arachide",
      description: "Riz blanc accompagné d’une sauce onctueuse à base d’arachide et de viande mijotée.",
      prix: 14.00,
      image: "assets/images/Repas/rizsaucearachide.jpeg",
    ),
    Repas(
      nom: "chièp (Thieboudienne)",
      description: "Riz sénégalais parfumé, servi avec poisson, carottes, chou et légumes mijotés.",
      prix: 19.00,
      image: "assets/images/Repas/Tchiep.jpg",
    ),
    Repas(
      nom: "Salade poulet braisé",
      description: "Soupe ou ragoût nourrissant à base de pois chiches, de couscous perlé (Maftoul), de carottes et de courgettes, dans un bouillon épicé à la tomate. Servi avec des quartiers d'œuf dur.",
      prix: 12.00,
